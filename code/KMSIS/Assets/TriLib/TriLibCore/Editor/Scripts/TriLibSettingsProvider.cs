...
namespace TriLibCore.Editor
{
    public class TriLibSettingsProvider : SettingsProvider
    {
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            GUILayout.Label("You can disable file formats you don't use ");
            EditorGUILayout.Space();
            var changed = false;
            ...
            GUILayout.Label("You can disable in Editor file-formats importing to avoid conflicts with other importers");
            EditorGUILayout.Space();
