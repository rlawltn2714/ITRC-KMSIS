...
namespace TriLibCore.Textures
{
    ...
    public static class TextureLoader
    {
        ...
        {
            if (textureLoadingContext.Context.LoadedTextureGroups.TryGetValue(textureLoadingContext.Texture, out var existingTextureGroup))
            {
                textureLoadingContext.OriginalUnityTexture = existingTextureGroup.OriginalUnityTexture;
                textureLoadingContext.UnityTexture = existingTextureGroup.UnityTexture;
            ...
            textureLoadingContext.TextureLoaded = textureLoadingContext.UnityTexture != null;
